pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.61.120.35:9090/manager/html'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/phani2498/FullstackforAWS.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://13.61.120.35:9090/springapp1"
            echo "✅ Frontend deployed: http://13.61.120.35:9090/frontapp1"
        }
        failure {
